...
public class LightManager {
    ...
    public static void main(String[] args) {
        ...
        GasLight gasLamp = new GasLight("USA",345);
        ...
        System.out.println(" ");
        list.stream()
                .filter(light -> light.getWorkTimeInMinutes()> 34).forEach(System.out::println);

        System.out.println(" ");
        list.stream()
                .filter(light -> light.getProducer() == " USA ").forEach(System.out::println);
